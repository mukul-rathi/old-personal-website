...
*/
    const {img, category,date, title, description, link1, link2,socialButton, className} = props;
    ...
    <section className={classNames(styles.card, className)}>
        ...
        <div  className={styles.socialButtonDiv}>
            <SocialButton img={socialButton.img} href={socialButton.href} className={styles.socialButton}/>
         </div> 
        }
