    ...
    <section className={styles.twitterCard}>
      <div className={styles.mainContent}>
        ...
        <div className={styles.description}>
          I'd love to hear your thoughts: always looking for feedback and will
          do my best to answer any questions you might have! I tweet whenever
          any <strong>new posts</strong> drop.
