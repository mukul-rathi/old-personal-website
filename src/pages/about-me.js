...
const AboutMe = () => {
    return (
        <Layout page="About Me">
            <SEO isBlogPost={false} title="About Mukul Rathi" url="https://mukul-rathi.github.io/about-me/" excerpt="A bit about me and the activities I get up to" image={HaCImage}/>
            <WhoAmI/>
